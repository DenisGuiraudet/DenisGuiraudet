...
- **Geeky but Not Forced**: Incorporate organic references to gaming, anime, and nerd culture.
  - *Approved References*: World of Warcraft (raiding/mains), Civilization (tech trees), Hunter x Hunter (Nen mastery analogy), SimCity (urban planning for code architecture), One Piece (pirate themes), Evangelion, Tabletop RPGs, Counter-Strike.
